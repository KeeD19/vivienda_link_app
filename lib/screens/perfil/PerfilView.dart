...
class _PerfilViewState extends State<PerfilView> {
  ...
  void initState() {
    ...
    ordersProvider.getContact();
    ordersProvider.getDataPerfil().then((_) {
      if (ordersProvider.dataClient != null) {
        setState(() {
  ...
  Future<void> _makePhoneCall(String phoneNumber) async {
    ...
    if (await canLaunchUrl(callUri)) {
      ...
      showCustomSnackBar(context, 'Could not launch $callUri', isError: true);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ordersProvider.isLoading || contact == null || client == null
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          height: _onEdit ? screenHeight * 0.6 : screenHeight * 0.2,
                          width: screenWidth * 1,
                                    ...
                                    children: [
                                      ...
                                      _onEdit
                                          ? _imageBase64 != null
                                              ? ClipOval(
                                                  child: Image.memory(
                                                    base64Decode(client.selfie!),
                                                    width: 60, // Ajusta el tamaño de la imagen redonda
                                                    height: 60,
                                                    fit: BoxFit.cover,
                                                  ),
                                                )
                                              : ClipOval(
                                                  child: Image.asset(
                                                    ...
                                                    width: 60, // Tamaño ajustado del ícono redondo
                                                    height: 60,
                                                    fit: BoxFit.cover,
                                                  ),
                                                )
                                          ...
                                          ? Flexible(
                                              child: TextField(
                                                ...
                                                decoration: InputDecoration(
                                                    ...
                                                    labelText: _errorName != "" ? _errorName : 'Nombre',
                                          ...
                                          ? Flexible(
                                              child: TextField(
                                                  ...
                                                  decoration: InputDecoration(
                                                      ...
                                                      labelText: _errorName != "" ? _errorEmail : 'Correo',
                                                      labelStyle: TextStyle(color: Theme.of(context).colorScheme.secondary))))
                                          : Padding(
                                              padding: const EdgeInsets.symmetric(
                                                horizontal: 15,
                                          ...
                                          ? Flexible(
                                              child: TextField(
                                                  ...
                                                  decoration: InputDecoration(
                                                      ...
                                                      labelText: _errorName != "" ? _errorName : 'Telefono',
                                                      labelStyle: TextStyle(color: Theme.of(context).colorScheme.secondary))),
                                            )
                                          : Padding(
                                              padding: const EdgeInsets.symmetric(
                                                    ...
                                                    if (nameController.text.isNotEmpty) {
                                                      if (phoneController.text.isNotEmpty) {
                                                        if (emailController.text.isNotEmpty) {
                                                          ...
                                                          _errorEmail = "No puede estar vacio";
                                                        }
                                                      } else {
                                                        _errorPhone = "No puede estar vacio";
                                                      }
                                                    } else {
                                                      _errorName = "No puede estar vacio";
                                                    }
                                                    _onEdit = !_onEdit;
                                                  });
                                                },
                                                style: ButtonStyle(backgroundColor: WidgetStateProperty.all(AppColors.bluePrimaryColor)),
                                                child: const Text(
                                                  'Guardar',
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  ...
                                  IconButton(
                                    icon: Icon(_onChngePassword ? Icons.cancel : Icons.change_circle_outlined),
                                    onPressed: () {
                                      setState(() {
                                ...
                                _onChngePassword
                                    ? TextButton(
                                        onPressed: () {
                                          setState(() async {
                                            final scaffoldContext = context;
                                            if (passOldController.text.isNotEmpty || passNewController.text.isNotEmpty) {
                                              ...
                                              showCustomSnackBar(scaffoldContext, "Las contraseñas no pueden estar vacias", isError: true);
                                            }
                                          });
                                        },
                                        style: ButtonStyle(
                        ...
                        child: InkWell(
                          onTap: () {
                            if (contact['nombreContacto'] != null) {
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ContactoEmergenciaPage()));
                            }
                          },
                          child: Container(
                            height: 60,
                                              ...
                                              onPressed: () => {
                                                    setState(() async {
                                                      ...
                                                      if (ordersProvider.errorMessage.isEmpty) {
                                                        showCustomSnackBar(context, 'Se elimino correctamente', isError: false);
                                                        ordersProvider.getContact();
                                                      } else {
